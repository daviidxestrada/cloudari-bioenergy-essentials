...
= 1.4.19 =
* Sync live contact previews from WordPress visual editor iframes.
* Copy visual editor iframe content back to textareas before saving.

= 1.4.18 =
* Update contact previews live while editing rich text fields.
* Show an unsaved changes warning on the active contact widget editor.
* Keep the selected contact widget tab active after saving.

= 1.4.17 =
* Load the WordPress editor assets from the Datos Contacto admin hook.

= 1.4.16 =
* Replace line-only contact fields with WordPress visual text editors.
* Allow rich contact content with safe links for mailto, tel, and normal URLs.
